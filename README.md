...
#### Версия stable: 20250314_01 (В соседней ветке dev версии)
...
- `./conf/use-color-text` - файл настройки цветного текста (0 - отключить, 1 - включить). Если файл не существует или значение некорректно, то по умолчанию включено использование цветного текста.
